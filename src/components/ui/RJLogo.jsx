 ...
 * RJLogo — brand mark
 *
 * Uses adaptive design tokens so it switches automatically with dark mode:
 *   RJ letterforms → var(--accent)  (#813746 light / #e36f86 dark)
 *   Dot             → var(--fg)     (#222222 light / #fffbf5 dark)
 *
